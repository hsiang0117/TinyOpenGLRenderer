...
public:
	...
	static MeshPtr generateSphere(float radius, int sectorCount, int stackCount);
	static MeshPtr generatePlane(float width, float height, int widthSegments, int heightSegments);
	static MeshPtr generateQuad(float width, float height);
};
